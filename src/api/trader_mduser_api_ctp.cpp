...
static void ctp_mduser_on_rsp_user_login(void* arg, CThostFtdcRspUserLoginField *pRspUserLogin, CThostFtdcRspInfoField *pRspInfo, int nRequestID, int bIsLast);
static void ctp_mduser_on_rsp_user_logout(void* arg, CThostFtdcUserLogoutField *pRspUserLogout, CThostFtdcRspInfoField *pRspInfo, int nRequestID, int bIsLast);
...
void ctp_mduser_on_rsp_user_login(void* arg, CThostFtdcRspUserLoginField *pRspUserLogin, CThostFtdcRspInfoField *pRspInfo, int nRequestID, int bIsLast)
{
  trader_mduser_api* self = (trader_mduser_api*)arg;
...
void ctp_mduser_on_rsp_user_logout(void* arg, CThostFtdcUserLogoutField *pRspUserLogout, CThostFtdcRspInfoField *pRspInfo, int nRequestID, int bIsLast)
{
  trader_mduser_api* self = (trader_mduser_api*)arg;
...
void ctp_mduser_on_rsp_error(void* arg, CThostFtdcRspInfoField *pRspInfo, int nRequestID, int bIsLast)
{
  trader_mduser_api* self = (trader_mduser_api*)arg;
...
void ctp_mduser_on_rsp_sub_market_data(void* arg, CThostFtdcSpecificInstrumentField *pSpecificInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, int bIsLast)
{
  trader_mduser_api* self = (trader_mduser_api*)arg;
...
void ctp_mduser_on_rsp_un_sub_market_data(void* arg, CThostFtdcSpecificInstrumentField *pSpecificInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, int bIsLast)
{
  trader_mduser_api* self = (trader_mduser_api*)arg;
