 ...
 *
 *  $Id: glbProfile.c,v 1.1 2012/11/18 05:49:00 huilu Exp $
 *
 *  This program provide profile operator.
 *
 *  Edit History:
 *
...
static char *ID = "$Id: glbProfile.c,v 1.1 2012/11/18 05:49:00 huilu Exp $";
